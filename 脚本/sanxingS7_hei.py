...
if deviceName in devices:
    ...
    # popen返回文件对象，跟open操作一样
    with os.popen(r'adb connect 192.168.2.251:5558', 'r') as f:
        try:
            text1 = f.read()
            # print(text) # 打印cmd输出结果
            # 输出结果字符串处理
...
# 开端口
# adb -s fa113ad3 tcpip 5558
# 连接三星s8
# adb connect 192.168.2.251:5558
# 断开连接
# adb disconnect connect 192.168.2.251:5558
